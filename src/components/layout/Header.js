  ...
  return (
    <header className="bg-white shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <nav className="hidden md:flex items-right space-x-4">
            <Link to="/" className="text-neutral-900 hover:text-primary-500 px-3 py-2 rounded-md text-base font-medium">Home</Link>
            <Link to="/services" className="text-neutral-900 hover:text-primary-500 px-3 py-2 rounded-md text-base font-medium">Services</Link>
            <Link to="/about" className="text-neutral-900 hover:text-primary-500 px-3 py-2 rounded-md text-base font-medium">About Us</Link>
            <Link to="/contact" className="text-neutral-900 hover:text-primary-500 px-3 py-2 rounded-md text-base font-medium">Contact</Link>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-neutral-200 px-4 py-2 flex justify-around items-center">
        <Link to="/" className="flex flex-col items-center text-neutral-600 hover:text-primary-500">
          <Home size={20} />
          <span className="text-xs mt-1">Home</span>
        </Link>
        <Link to="/services" className="flex flex-col items-center text-neutral-600 hover:text-primary-500">
          <Briefcase size={20} />
          <span className="text-xs mt-1">Services</span>
        </Link>
        <Link to="/about" className="flex flex-col items-center text-neutral-600 hover:text-primary-500">
          <Users size={20} />
          <span className="text-xs mt-1">About</span>
        </Link>
        <Link to="/contact" className="flex flex-col items-center text-neutral-600 hover:text-primary-500">
          <Mail size={20} />
