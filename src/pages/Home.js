...
import { ArrowRight, BarChart2, Shield, Users, TrendingUp, PiggyBank, Clock, Calculator, IndianRupee } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-primary-50 to-white">
      ...
      <footer className="py-8 px-4 text-center text-sm text-neutral-600">
        ...
        <p className="mt-2">
          © 2024 [Your Company Name]. All rights reserved. SEBI Registration No: XXXXXXXXXX
        </p>
      </footer>
    </div>
  );
